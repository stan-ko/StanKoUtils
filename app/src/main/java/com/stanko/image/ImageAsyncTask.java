...
public abstract class ImageAsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = SdkBuildUtils.hasHoneycomb() ? new SerialExecutor() :
     ...
     * @see #execute(Object[])
     */
    public final ImageAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
