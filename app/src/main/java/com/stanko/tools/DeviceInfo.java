...
//	            }
     ...
     * @param Context (to be able to work with SharedPrefs)
...
//    		if (DeviceInfo.displayDensity>320)
//    			maxSideSize = 512;
    	}
    	return maxSideSize;
    }
    ...
    public static Boolean isTabletByScreen(){
    	...
    	boolean bySrceen = screenSize >= Configuration.SCREENLAYOUT_SIZE_LARGE 
    			& screenInches >=7
