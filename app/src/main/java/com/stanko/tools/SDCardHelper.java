...
public class SDCardHelper {
	...
	private static String SD_CACHE_PATH = "/Android/data/"+SD_DEFAULT_PACKAGE+"/cache/";
...
//			fileDir.mkdirs();
		...
		boolean isSucceed = FileUtils.byteArrayToFile(img, file);
...
//		final File fileDir = getCacheDir();
//		if (fileDir!=null && !fileDir.exists())
//			fileDir.mkdirs();
...
//		}
	...
	public static String[] getAPKExpansionFiles(final Context context, final int mainVersion, final int patchVersion) {
	    ...
	    final File expPath = new File(root.toString() + EXP_PATH + packageName);
	...
	/**
	 * Returns set of found external paths
	 * @return
	 */
